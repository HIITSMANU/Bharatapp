...
export const LoginForm = () => {
	...
	const handleLogin = async (e) => {
		...
		if (isSuccess) {
			if (prevLocation) {
				navigate(prevLocation); // Navigate back to the previous location
			} else {
				navigate(-1); // If prevLocation is not set, navigate back using -1
			}
		}
		setFormData({
			email: "",
			...
			{showForgotPasswordForm ? (
				...
				<div>
					...
					<div className={styles.midelem}>
						...
						<br />
						<p>
							Unlock Best prices and become an insider for our
							exclusive
							<br /> launches & offers. Complete your profile and
							get ₹250 worth
