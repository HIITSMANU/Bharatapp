...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/03-MAR/HP-Banner/toplisting/01/Desktop_1920x560_toplistingBracelets.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/03-MAR/HP-Banner/toplisting/01/Mobile_768x432_toplistingBracelets.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/03-MAR/HP-Banner/toplisting/01/Mobile_768x432_toplistingBracelets.jpg 1x" type="image/jpeg"></source>
            <img  src="https://cdn.caratlane.com/media/static/images/V4/2023/CL/03-MAR/HP-Banner/toplisting/01/Desktop_1920x560_toplistingBracelets.jpg" ></img>
            </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.total}>
                ...
                <h1><b>Bracelets</b> <span className={styles.count}>957 Designs</span></h1>
