...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="mangalsutra");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/ed19e9fc6ddd4de592b67776543499c1.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/9320f586c9df408fac5456cf54dc9cb0.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/9320f586c9df408fac5456cf54dc9cb0.jpg 1x" type="image/jpeg"></source>
            <img class="egpsk3h2 css-z9akz8 e1nln7oz0" data-src="" src="https://banner.caratlane.com/live-images/ed19e9fc6ddd4de592b67776543499c1.jpg" alt="Modern gold &amp; diamond Mangalsutra designs online" ></img>
            </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
          ...
          <DrawerBody>
            <Stack spacing='24px'>
              ...
              <Box>
                ...
                <Select  defaultValue='mangalsutra'>
                ...
                <option value="bracelets" onChange={(e)=>handlenav(e.target.value)}>Bracelets</option>
                ...
                <option value="charmb" onChange={(e)=>handlenav(e.target.value)}>Charm Builders</option>
                </Select>  
              </Box>
              </Stack>
              </DrawerBody>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Mangalsutra  <CloseIcon color="red"  /></a>
                        <span></span>
        ...
        <div className={styles.total}>
                <h1><b>Mangalsutra</b> <span className={styles.count}>313 Designs</span></h1>
            </div>
                ...
                <div className={styles.filterdiv}>
                    ...
                    <div className={styles.fillist}>
                        ...
                        <div className={styles.filcat}>
                            ...
                            <label >
                                <i></i>
                                <input type="radio" name="checkbox" id="checkbox" value="bracelets" onChange={(e)=>handlenav(e.target.value)}/>
                                    <span className={styles.filtext}>
                            ...
                            <label >
                                <i></i>
                                <Radio name="checkbox" id="checkbox" bg="#8863fb"></Radio>                                    <span className={styles.filtext}>
                            ...
                            <label >
                                <i></i>
                                <input type="radio" name="checkbox" id="checkbox" value="charmb" onChange={(e)=>handlenav(e.target.value)}/>
                                    <span className={styles.filtext}>
