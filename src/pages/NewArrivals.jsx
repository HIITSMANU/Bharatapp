...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
        <picture>
            <source media="(min-width: 993px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/07-JULY/AppBanner/Newin/01/Desktop_1920x560_toplisting.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/07-JULY/AppBanner/Newin/01/mobile_768x432_toplisting.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/07-JULY/AppBanner/Newin/01/mobile_768x432_toplisting.jpg 1x" type="image/jpeg"></source>
            <img src="https://cdn.caratlane.com/media/static/images/V4/2023/CL/07-JULY/AppBanner/Newin/01/Desktop_1920x560_toplisting.jpg" alt="" /></picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
          ...
          <DrawerBody>
            <Stack spacing='24px'>
              ...
              <Box>
                ...
                <Select id='owner' defaultValue='bestsellers'>
                <option value='bestsellers' onChange={(e)=>handleFilter(e.target.value)}>All</option>
        ...
        <div className={styles.navlist}>
                ...
                <div className={styles.selector}>
                        <form action="#">
                <label>Sort By:</label>
                <select name="sort"  className="sort-selection" onChange={(e)=>setsortorder(e.target.value)}>
                <option value="latest">Latest</option>
                <option value="discount">Discount</option>
                <option value="featured">Featured</option>
                <option value="low">Price: Low to High</option>
        ...
        <div className={styles.total}>
                <h1><b>New Arrivals</b> <span className={styles.count}> 205 Designs</span></h1>
                ...
                <div className={styles.filterdiv}>
                    ...
                    <div className={styles.fillist}>
                        ...
                        {/* <div className="filcatsub">
                            <label >
                                <i></i>
                                <Radio name="checkbox" id="checkbox" bg="#8863fb" value="bestsellers" onChange={(e)=>handleFilter(e.target.value)}></Radio>
