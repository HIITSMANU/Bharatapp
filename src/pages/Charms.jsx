...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="charms");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/c9aa444d8c534d78a57f13b72329408e.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/8de6500c39d048e4807f7a92e30f44ba.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/8de6500c39d048e4807f7a92e30f44ba.jpg 1x" type="image/jpeg"></source>
            <img class="egpsk3h2 css-z9akz8 e1nln7oz0" data-src="" src="https://banner.caratlane.com/live-images/c9aa444d8c534d78a57f13b72329408e.jpg" alt="Shop Latest Collection of Gold Charms for Men and Women" ></img>
            </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Charms  <CloseIcon color="red"  /></a>
                        <span></span>
...
<div className={styles.selector}>
        ...
        <div className={styles.total}>
                <h1><b>Charms</b> <span className={styles.count}>97 Designs</span></h1>
