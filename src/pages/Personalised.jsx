...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/317f8fbce1cc421ba4ceb65e76f9ab29.jpg" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/ffbcf106907c4141b73af5e088df2611.jpg
" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/ffbcf106907c4141b73af5e088df2611.jpg

" type="image/jpeg"></source>
            <img src="https://banner.caratlane.com/live-images/317f8fbce1cc421ba4ceb65e76f9ab29.jpg
" alt="" /></picture>
        </div>
          ...
          <DrawerBody>
            <Stack spacing='24px'>
              ...
              <Box>
                ...
                <option value='earrings'>Personalised</option>
            ...
            <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Personalized  <CloseIcon color="red"  /></a>
                        <span></span>
            ...
            <div className={styles.total}>
                <h1><b>Personalized</b> <span className={styles.count}>100 Designs</span></h1>
