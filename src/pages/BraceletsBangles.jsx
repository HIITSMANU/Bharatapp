...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="bracelet"||el.category ==="Bangles");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
        <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/dab8c9bccb50479fbad968e7ea6ea450.webp 1x" type="image/webp"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/c67b675db1b44f0bb0e204cbb440cf7f.webp 1x" type="image/webp"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/c67b675db1b44f0bb0e204cbb440cf7f.webp 1x" type="image/webp"></source>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Bracelets  <CloseIcon color="red" size="xs" /></a>
                        <span></span>
                        <a href="" style={{textDecoration:"none"}}> Bangles  <CloseIcon color="red"  size="xs"/></a>
                        <span></span>
        ...
        <div className={styles.total}>
                ...
                <h1><b>Bracelets & Bangles</b> <span className={styles.count}>1076 Designs</span></h1>
                ...
                <div className={styles.filterdiv}>
                    ...
                    <div className={styles.fillist}>
                        ...
                        <div className={styles.filcat}>
                            ...
                            <label >
                                <i></i>
                                <Radio type="radio" name="checkbox" id="checkbox" value="bracelets" onChange={(e)=>handlenav(e.target.value)} bg="#8863fb"/>
                                <span className={styles.filtext}>
                            ...
                            <label >
                                <i></i>
                                <Radio type="radio" name="checkbox" id="checkbox" value="bangles" onChange={(e)=>handlenav(e.target.value)} bg="#8863fb"/>
                                <span className={styles.filtext}>
