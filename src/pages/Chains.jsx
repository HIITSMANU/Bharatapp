...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="chains");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/aed4b98ddbb548a2b4e9f71065d733e1.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/61ae24d192d049ada8b8b07cbcf62a6a.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/61ae24d192d049ada8b8b07cbcf62a6a.jpg 1x" type="image/jpeg"></source>
            <img class="egpsk3h2 css-z9akz8 e1nln7oz0" data-src="" src="https://banner.caratlane.com/live-images/aed4b98ddbb548a2b4e9f71065d733e1.jpg" ></img>
            </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Chains  <CloseIcon color="red"  /></a>
                        <span></span>
        ...
        <div className={styles.total}>
                <h1><b>Chains</b> <span className={styles.count}>35 Designs</span></h1>
            </div>
