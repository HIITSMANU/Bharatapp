...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="Necklaces");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
           <picture>
           <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/20effb3bd6e145f5a46e984d9b4792f9.jpg 1x" type="image/jpeg"/>
           <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/bbf86f7c7cc34668acc933800665fe4e.jpg 1x" type="image/jpeg"/>
           <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/bbf86f7c7cc34668acc933800665fe4e.jpg 1x" type="image/jpeg"></source>
           <img src="https://banner.caratlane.com/live-images/20effb3bd6e145f5a46e984d9b4792f9.jpg" ></img>
           </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Necklaces  <CloseIcon color="red"  /></a>
                        <span></span>
        ...
        <div className={styles.total}>
                <h1><b>Necklaces</b> <span className={styles.count}>756 Designs</span></h1>
