...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
        <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/10c2cf82f2ad425b960f2587933652a7.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/e67333190483448aa45fd66d4b9c143c.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/e67333190483448aa45fd66d4b9c143c.jpg 1x" type="image/jpeg"></source>
            <img src="https://banner.caratlane.com/live-images/10c2cf82f2ad425b960f2587933652a7.jpg" alt="" /> </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
          ...
          <DrawerBody>
            <Stack spacing='24px'>
              ...
              <Box>
                ...
                <Select id='owner' defaultValue='rings'>
        ...
        <div className={styles.navlist}>
            ...
            <div className={styles.total}>
                <h1><b>Rings</b> <span className={styles.count}>1915 Designs</span></h1>
