...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="Bangles");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/6543b39b77a7415d83de1dc7141255b2.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/4f9132049c334f12bbcca3bd729ecdb5.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/4f9132049c334f12bbcca3bd729ecdb5.jpg 1x" type="image/jpeg"></source>
            <img class="egpsk3h2 css-z9akz8 e1nln7oz0" data-src="" src="https://banner.caratlane.com/live-images/6543b39b77a7415d83de1dc7141255b2.jpg" alt="Fancy designer gold and platinum Bangles for women"></img>
            </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.total}>
                <h1><b>Bangles</b> <span className={styles.count}>119 Designs</span></h1>
            </div>
