...
function handleFilter(){
    let newdata=fData.filter((el)=>el.price<=15000);
    setFData1(newdata);
    setFData2(newdata);
}
          ...
          <DrawerBody>
            <Stack spacing='24px'>
              ...
              <Box>
                ...
                <option value='earrings'>Price under 15000</option>
            ...
            <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Price under 15000  <CloseIcon color="red"  /></a>
                        <span></span>
            ...
            <div className={styles.total}>
                <h1><b>Price under 15000</b> <span className={styles.count}>100 Designs</span></h1>
