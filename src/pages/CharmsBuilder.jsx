...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/43288773f0fe4cc3ab5b6ea1c71b753e.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/088544741a384e82b87235704a962655.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/088544741a384e82b87235704a962655.jpg 1x" type="image/jpeg"></source>
            <img class="egpsk3h2 css-z9akz8 e1nln7oz0" data-src="" src="https://banner.caratlane.com/live-images/43288773f0fe4cc3ab5b6ea1c71b753e.jpg" alt="" ></img>
            </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Charm Builders  <CloseIcon color="red"  /></a>
                        <span></span>
...
<div className={styles.selector}>
        ...
        <div className={styles.total}>
                <h1><b>Charm Builders</b> <span className={styles.count}>4 Designs</span></h1>
