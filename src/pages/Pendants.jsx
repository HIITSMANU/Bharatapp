...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="Pendants");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
           <picture>
           <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/01ce60ec207b48f4b8340499c225a4d6.jpg 1x" type="image/jpeg"></source>
           <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/cf87d44123264c0eaf2cd1797105b45f.jpg 1x" type="image/jpeg"></source>
           <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/cf87d44123264c0eaf2cd1797105b45f.jpg 1x" type="image/jpeg"></source>
           <img src="https://banner.caratlane.com/live-images/01ce60ec207b48f4b8340499c225a4d6.jpg" ></img>
           </picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Pendants  <CloseIcon color="red"  /></a>
                        <span></span>
        ...
        <div className={styles.total}>
                <h1><b>Pendants</b> <span className={styles.count}>672 Designs</span></h1>
