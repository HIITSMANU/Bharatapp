...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/04-APR/AppBanner/Earring/01/Desktop_1920x560_toplisting.jpg 1x" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/04-APR/AppBanner/Earring/01/mobile_768x432_toplisting.jpg 1x" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://cdn.caratlane.com/media/static/images/V4/2023/CL/04-APR/AppBanner/Earring/01/mobile_768x432_toplisting.jpg 1x" type="image/jpeg"></source>
            <img src="https://cdn.caratlane.com/media/static/images/V4/2023/CL/04-APR/AppBanner/Earring/01/Desktop_1920x560_toplisting.jpg" alt="" /></picture>
        </div>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            ...
            <div className={styles.total}>
                <h1><b>Earrings</b> <span className={styles.count}>2295 Designs</span></h1>
