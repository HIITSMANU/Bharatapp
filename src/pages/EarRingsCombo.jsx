  ...
  return (
    <div>
        <div id="banner">
            ...
            <picture>
            <source media="(min-width: 993px)" srcset="https://assets.cltstatic.com/images/responsive/DefaultBanner_Desktop.webp 1x" type="image/webp"/>
            <source media="(min-width: 768px)" srcset="https://assets.cltstatic.com/images/responsive/DefaultBanner_Mobile.webp 1x" type="image/webp"></source>
            <source media="(min-width: 320px)" srcset="https://assets.cltstatic.com/images/responsive/DefaultBanner_Mobile.webp 1x" type="image/webp"></source>
            <img src="https://assets.cltstatic.com/images/responsive/DefaultBanner_Desktop.webp" alt="" /></picture>
        </div>
     ...
     <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <div className={styles.total}>
                <h1><b>Jewellery</b> <span className={styles.count}>813 Designs</span></h1>
                ...
                <div className={styles.filterdiv}>
                    ...
                    <div className={styles.fillist}>
                        ...
                        <div className={styles.filcat}>
                            ...
                            <label >
                                <i></i>
                                <Radio type="radio" name="checkbox" id="checkbox" value="earrings" onChange={(e)=>handlenav(e.target.value)} bg="#8863fb"/>
                                <span className={styles.filtext}>
                            ...
                            <label >
                                <i></i>
                                    <Radio type="radio" name="checkbox" id="checkbox" value="rings" onChange={(e)=>handlenav(e.target.value)} bg="#8863fb"/>
                                    <span className={styles.filtext}>
