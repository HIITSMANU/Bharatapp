...
function handleFilter(){
    let newdata=fData.filter((el)=>el.gifttype ==="Anniversary");
    setFData1(newdata);
    setFData2(newdata);
}
...
function handlenav(value){
  ...
  return (
    <div>
        <div id="banner">
            <picture>
            <source media="(min-width: 993px)" srcset="https://banner.caratlane.com/live-images/5d89e218eb56457c9814f8e2f7b8b6ec.jpg" type="image/jpeg"/>
            <source media="(min-width: 768px)" srcset="https://banner.caratlane.com/live-images/a66c3ee1b3db4f70a4aaca9d816f5ba3.jpg" type="image/jpeg"></source>
            <source media="(min-width: 320px)" srcset="https://banner.caratlane.com/live-images/a66c3ee1b3db4f70a4aaca9d816f5ba3.jpg
" type="image/jpeg"></source>
            <img src="https://banner.caratlane.com/live-images/5d89e218eb56457c9814f8e2f7b8b6ec.jpg" alt="" /></picture>
        </div>
          ...
          <DrawerBody>
            <Stack spacing='24px'>
              ...
              <Box>
                ...
                <option value='earrings'>Anniversary</option>
            ...
            <div className={styles.navlist}>
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Anniversary  <CloseIcon color="red"  /></a>
                        <span></span>
            ...
            <div className={styles.total}>
                <h1><b>Anniversary</b> <span className={styles.count}>100 Designs</span></h1>
